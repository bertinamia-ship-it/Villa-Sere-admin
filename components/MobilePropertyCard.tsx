...
export default function MobilePropertyCard() {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 px-2.5 py-2 bg-gradient-to-r from-white to-slate-50/80 backdrop-blur-sm rounded-lg border border-slate-200/60 shadow-sm">
  ...
  if (!activeProperty) {
    return (
      <div className="flex items-center gap-2 px-2.5 py-2 bg-gradient-to-r from-slate-100 to-slate-50 rounded-lg border border-slate-200/60 shadow-sm">
  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
      >
        <div className="shrink-0 p-1.5 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 rounded-md shadow-sm ring-1 ring-blue-400/20">
        ...
        <div className="shrink-0 p-1 bg-slate-100 rounded-md group-hover:bg-slate-200 transition-colors">
