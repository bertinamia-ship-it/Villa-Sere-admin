...
const enTranslations = {
  ...
  settings: {
    ...
    myPlan: {
      title: 'My Plan',
      subtitle: 'Manage your subscription and limits',
      planStatus: 'Plan Status',
      trialActive: 'Trial Period Active',
      trialExpired: 'Trial Expired',
      activePlan: 'Active Plan',
      pricePerProperty: '$20 USD / property / month',
      paymentsComingSoon: 'Payments coming soon',
      daysRemaining: '{days} days left',
      daysRemainingSingular: '1 day left',
    },
  ...
  errors: {
    ...
    dateRequired: 'Date is required',
    tableNotFound: 'Database error: table not found',
  },
  ...
  billing: {
    ...
    trialExpiredOn: 'Your trial expired on',
  ...
  // Onboarding
  onboarding: {
    welcome: 'Welcome to CasaPilot!',
    welcomeDescription: 'Let\'s set up your first property in 3 simple steps.',
    step1Title: 'Step 1: Create your first property',
    step1Description: 'Start by adding basic information about your property.',
    step2Title: 'Step 2: Create a bank account',
    step2Description: 'Add an account to manage your finances.',
    step3Title: 'Step 3: Record your first expense',
    step3Description: 'Start tracking your expenses.',
    allDone: 'All set!',
    allDoneDescription: 'You\'re all set up. Start managing your property!',
  ...
  // Trial
  trial: {
    daysRemaining: 'You have {days} days left in your trial',
    daysRemainingSingular: 'You have 1 day left in your trial',
    trialExpired: 'Your trial period has expired',
    trialExpiredDescription: 'Activate your plan to continue using CasaPilot without limits.',
    activatePlan: 'Activate Plan',
    trialActive: 'Trial Period Active',
    readOnlyMode: 'Read-Only Mode',
    readOnlyDescription: 'Your trial has expired. Activate your plan to edit and create new items.',
    actionBlocked: 'This action is blocked because your trial has expired.',
    upgradeToContinue: 'Upgrade your plan to continue using CasaPilot.',
  },
